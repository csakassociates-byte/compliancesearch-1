          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              },
              {
                ...
                items: ["AGM Minutes SS-2", "Board Meeting Minutes SS-1", "Share Certificate Form SH-1", "Share Transfer Deed SH-4", "Certified True Copy (CTC)", "DIR-3 KYC compliance", "Annual compliance calendar", "MCA V3 portal filings"],
              },
              {
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 mb-6">
            ...
            <div>
              ...
              <div className="space-y-1.5">
                {[["Bank Resolution", "/tools/documents/bank-resolution"], ["Share Certificate", "/tools/documents/share-certificate"], ["Share Transfer", "/tools/documents/share-transfer"], ["Penalty Calculator", "/tools/penalty-calculator"]].map(([l, h]) => (
                  <Link key={h} href={h} className="block text-xs hover:text-white transition">{l}</Link>
                ))}
              </div>
            </div>
