...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/tools/documents/minutes/egm`,          lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/tools/documents/minutes/board`,        lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${base}/tools/documents/minutes/committee`,    lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${base}/tools/corporate-action-kit/auditor-appointment`,      lastModified: now, changeFrequency: "monthly", priority: 0.9 },
