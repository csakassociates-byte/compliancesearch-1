...
const TYPES = [
  ...
  },
  {
    ...
    title: "EGM Minutes",
    icon: "⚡",
    desc: "Extraordinary General Meeting — special resolutions, capital restructuring, MOA/AOA alterations, director appointments.",
    tags: ["SS-2 Compliant", "Special Resolutions", "MOA/AOA", "Auto ROC Reminders"],
  ...
  },
  {
    ...
    icon: "👥",
    desc: "Audit Committee, NRC, CSR Committee, Risk Committee, SRC, Finance Committee — as per SEBI LODR and Companies Act.",
    tags: ["Audit Committee", "NRC", "CSR Committee", "Risk / SRC / Finance"],
