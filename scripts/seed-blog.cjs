...
DIR-12 for Director at General Meeting (Section 152): within 30 days of AGM/EGM date.
...
SS-1 is the Secretarial Standard for Board Meetings issued by the Institute of Company Secretaries of India (ICSI) and notified by the Ministry of Corporate Affairs. It became mandatory for all companies (except OPCs and small companies for certain provisions) from 1 July 2015 under Section 118(10) of the Companies Act 2013.

SS-1 NOTICE REQUIREMENTS

The notice of Board Meeting must be sent to every director at their address registered with the company. The minimum notice period is 7 days. The notice must include:
...
For email notice, the director must have given written consent to receive notices by email.
...
For a company with 3 directors, quorum is 2. For a company with 10 directors, quorum is 4 (one-third rounds up to 4). Important: The quorum must be present throughout the meeting, not just at the commencement.
...
A Certified True Copy is an extract of the resolution from the minutes, certified as a true copy by a Director or Company Secretary. CTCs are needed for bank submissions, ROC filings (DIR-12, ADT-1), and property transactions. The CTC must include the company letterhead, meeting details, full resolution text, and certification: "Certified to Be True — For and on behalf of [Company Name]."
...
The Directors' Report is a mandatory attachment to AOC-4. It must include:

- State of company's affairs and overview of business
- Material changes affecting the company's financial position after year-end
...
CARO 2020 (Companies Auditor's Report Order 2020) requires the statutory auditor to report on specific matters. It applies to all companies EXCEPT:

- Banking, insurance, and Section 8 companies
- One Person Companies
- Small companies
- Private limited companies where all three conditions are met: paid-up capital not exceeding Rs. 1 crore AND borrowings from banks or FIs not exceeding Rs. 1 crore AND turnover not exceeding Rs. 10 crore

If your private limited company has bank borrowings exceeding Rs. 1 crore, or turnover exceeding Rs. 10 crore, CARO 2020 applies.

AOC-4 LATE FILING FEES (FY 2025-26)

Under Section 403, filing AOC-4 after the due date attracts additional fees of Rs. 100 per day — there is no cap. The fee accrues from the day after the due date until the date of actual filing.
...
STEP #5 — Log in to MCA V3 portal. Navigate to e-Filing, Company Forms Submission, AOC-4. Upload all attachments, affix DSC, and file.

THE BOTTOM LINE

AOC-4 for FY 2025-26 is due by 30 October 2026 (if AGM held on 30 September 2026). The attachments include Directors' Report, Audit Report, CARO 2020, Cash Flow Statement, and subsidiary disclosures. Use the free Annual Filing Attachments Generator on ComplianceSearch.in to generate all documents in minutes — no manual drafting required.`,
},
...
Under Section 403 of the Companies Act 2013, the additional fee for late filing of any form is Rs. 100 per day of delay. This applies from the day after the due date until the date of actual filing. Normal filing fee (prescribed fee based on authorised share capital) is charged separately.

Real example: AOC-4 due date is 30 October 2026. Filed on 15 December 2026, a delay of 46 days. Additional fee = 46 x Rs. 100 = Rs. 4,600 (plus normal filing fee).
...
MGT-7 (companies other than OPCs and small companies): Within 60 days from the date of AGM. If AGM is 30 September 2026, MGT-7 is due by 29 November 2026.
...
Due date: 30 September of each year for directors who had DIN as on 31 March.

For FY 2025-26: DIR-3 KYC due by 30 September 2026.

Late fee: A flat penalty of Rs. 5,000 is levied (not per-day). The DIN is marked as "Deactivated" until KYC is completed and Rs. 5,000 is paid. A deactivated DIN director cannot sign any MCA form.

ADT-1 — AUDITOR APPOINTMENT

Due date: Within 15 days from the conclusion of the AGM (for auditor appointed at AGM under Section 139(1)).

For first auditors appointed by Board under Section 139(6): ADT-1 must be filed within 30 days of the Board meeting.
...
Due date: Within 30 days of passing the special resolution.

Applicable for special resolutions — MOA or AOA amendment, share capital increase, company name change.
...
Under Section 248, if a company fails to file AOC-4 or MGT-7 for 2 consecutive financial years, it can be struck off from the register of companies by the ROC. The company's DIN holders may also be disqualified under Section 164(2) if the company defaults on annual filings for 3 consecutive years.

What to do: Never let annual filings lapse for 2 or more years. File even with late fees — it is always cheaper than strike off and reinstatement.
...
What to do: Use the MCA Penalty Calculator on ComplianceSearch.in — enter the form, company type, and date and get the exact additional fee calculated instantly with a slab-wise breakdown.

THE BOTTOM LINE

MCA late fees are Rs. 100 per day with no upper cap. A 6-month delay on AOC-4 alone costs Rs. 18,000 in additional fees. The most important deadlines: AOC-4 within 30 days of AGM, MGT-7 within 60 days of AGM, DIR-3 KYC by 30 September every year, ADT-1 within 15 days of AGM. Use the free MCA Penalty Calculator on ComplianceSearch.in to compute your exact late fee for any form instantly.`,
},
...
GST registration is the process of enrolling your business under the Goods and Services Tax Act 2017. Upon registration, you receive a 15-digit GSTIN (Goods and Services Tax Identification Number). Once registered, you must collect GST from customers, file monthly or quarterly returns (GSTR-1 and GSTR-3B), and pay GST to the government by the due dates.

TURNOVER THRESHOLDS FOR 2025-26

Regular States — Goods Suppliers:

Turnover exceeding Rs. 40 lakh in a financial year makes GST registration mandatory. This applies to most states including Maharashtra, Delhi, Karnataka, Tamil Nadu, Gujarat, Rajasthan, and Uttar Pradesh.

Regular States — Service Suppliers:

Turnover exceeding Rs. 20 lakh in a financial year makes GST registration mandatory.

Special Category States:

For states in the Northeast (Manipur, Mizoram, Nagaland, Tripura) and hilly states (Uttarakhand, Himachal Pradesh), the threshold is: Goods Rs. 20 lakh, Services Rs. 10 lakh.
...
- E-commerce operators and sellers on Amazon, Flipkart and similar platforms
...
Businesses with aggregate turnover up to Rs. 1.5 crore (Rs. 75 lakh for special category states) can opt for the Composition Scheme under Section 10. Under Composition Scheme:
...
- Cannot charge GST on invoices — cannot make inter-state supplies
- Cannot claim Input Tax Credit

What to do: If your turnover is between Rs. 20 lakh and Rs. 1.5 crore for services, evaluate whether Composition Scheme reduces compliance burden for your business.

GST REGISTRATION PROCEDURE

STEP #1 — Visit gst.gov.in, click Registration, then New Registration.

STEP #2 — Fill Part A: Mobile number, email ID, state, PAN. Verify with OTP. Note the TRN (Temporary Reference Number).

STEP #3 — Fill Part B within 15 days of generating TRN: Business details, place of business, bank account, and authorised signatory details.

STEP #4 — Documents required: PAN card, Aadhaar card, business registration proof (certificate of incorporation for companies), address proof of principal place of business (rent agreement or electricity bill), bank statement or cancelled cheque, and photograph of the authorised signatory.

STEP #5 — Submit with DSC (for companies and LLPs) or e-Signature. GSTIN is typically allotted within 3 to 7 working days after verification.
...
GSTR-1 (Outward supplies): Monthly if turnover exceeds Rs. 5 crore (due 11th of next month) or quarterly under QRMP scheme (due 13th of month after quarter).
