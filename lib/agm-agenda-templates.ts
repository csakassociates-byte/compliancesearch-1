...
const ORDINARY_BUSINESS: AgmAgendaTemplate[] = [
  ...
  },
  {
    ...
    discussion: `Pursuant to the recommendation of the Board of Directors at its {boardMeetingSerial} Meeting held on {boardMeetingDate} under Section 123(1) of the Companies Act, 2013, the Chairman informed the Members that the Board of Directors had recommended a Final Dividend at the rate of {dividendRate} for the Financial Year {fy}. The Chairman stated that the dividend, if approved, would be paid to the Members whose names appear in the Register of Members / list of Beneficial Owners as on {recordDate}.`,
